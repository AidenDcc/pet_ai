...
- **底部导航三 Tab**：工作台 / 患宠 / 我的
- **工作台**：待审核报告、异常提醒概览、在线宠物 + 快捷入口宫格（报告审核 / 实时监测 / AI 分析 / 数据统计 进入二级页）
- **患宠**：宠物患者列表（无限滚动）、档案弹层（设备 / 宠物主信息）、问诊宠物回复
- **实时监测**：5 秒模拟采样的心率 / 血氧 / 体温 / 活动实时曲线（工作台二级页）
- **报告审核**：AI 报告待审列表，通过 / 驳回并填写意见（工作台二级页）
- **AI 智能分析**：深度健康分析报告、一键生成新分析（工作台二级页）
- **BI 数据看板**：患者 / 咨询 / 待审 / 报告量 KPI，物种分布、异常分布、周报告趋势图（工作台二级页）
- **我的**：医生资料卡（医院 / 职称 / 擅长）与接诊统计、修改密码、语言切换、关于 / 版本、退出登录
