...
export const userRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'user-community-compose',
        component: () => import('@/views/user/PostCompose.vue'),
        meta: { titleKey: 'user.community.composeTitle' },
      },
      {
        path: 'community/:id',
...
export const doctorRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      { path: '', redirect: '/doctor/dashboard' },
      {
        ...
        meta: { titleKey: 'nav.dashboard', hideNavbar: true },
      },
      {
        path: 'consultations',
        name: 'doctor-consultations',
        component: () => import('@/views/doctor/Consultations.vue'),
        meta: { titleKey: 'doctor.workbench.consultation' },
      },
      {
        path: 'patients',
        name: 'doctor-patients',
        component: () => import('@/views/doctor/Patients.vue'),
        meta: { titleKey: 'nav.patientPets' },
      },
      {
        path: 'profile',
        name: 'doctor-profile',
        component: () => import('@/views/doctor/Profile.vue'),
        meta: { titleKey: 'doctor.profile.title' },
      },
      {
        path: 'messages',
        name: 'doctor-messages',
        component: () => import('@/views/doctor/MessageCenter.vue'),
        meta: { titleKey: 'doctor.message.title' },
      },
      {
        path: 'messages/:id',
        name: 'doctor-message-detail',
        component: () => import('@/views/doctor/MessageDetail.vue'),
        meta: { titleKey: 'doctor.message.detailTitle' },
      },
      {
        path: 'settings',
        name: 'doctor-settings',
        component: () => import('@/views/doctor/Settings.vue'),
        meta: { titleKey: 'doctor.settings.title' },
      },
      {
        path: 'settings/feedback',
        name: 'doctor-settings-feedback',
        component: () => import('@/views/doctor/Feedback.vue'),
        meta: { titleKey: 'doctor.settings.feedback' },
      },
      {
        path: 'settings/services',
        name: 'doctor-settings-services',
        component: () => import('@/views/doctor/Services.vue'),
        meta: { titleKey: 'doctor.settings.services' },
      },
      {
        path: 'settings/services/:type',
        name: 'doctor-settings-service-detail',
        component: () => import('@/views/doctor/ServiceDetail.vue'),
        meta: { titleKey: 'doctor.settings.serviceDetail' },
      },
      {
        path: 'settings/cancel',
        name: 'doctor-settings-cancel',
        component: () => import('@/views/doctor/CancelAccount.vue'),
        meta: { titleKey: 'doctor.settings.cancelAccount' },
      },
      {
        path: 'telemetry',
        name: 'doctor-telemetry',
        component: () => import('@/views/doctor/Telemetry.vue'),
        meta: { titleKey: 'nav.telemetry' },
      },
      {
        path: 'reports',
        name: 'doctor-reports',
      ...
      },
      {
        ...
        meta: { titleKey: 'nav.aiAnalysis' },
      },
      {
        path: 'bi',
        name: 'doctor-bi',
        component: () => import('@/views/doctor/Bi.vue'),
        meta: { titleKey: 'nav.bi' },
      },
      {
        path: 'pet/:id',
      ...
      },
      {
        ...
        component: () => import('@/views/doctor/ChangePassword.vue'),
        meta: { titleKey: 'doctor.me.changePassword' },
      },
      {
        path: 'about',
        name: 'doctor-about',
        component: () => import('@/views/doctor/About.vue'),
        meta: { titleKey: 'doctor.me.about' },
      },
      {
        path: 'version',
        name: 'doctor-version',
        component: () => import('@/views/doctor/VersionInfo.vue'),
        meta: { titleKey: 'doctor.me.version' },
      },
    ],
  },
]
